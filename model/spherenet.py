...
import sys
sys.path.append("..")
from utils import xyz_to_dat, calculate_to_jimages_efficient
...
class SphereNetEncoder(torch.nn.Module):
    ...
    def forward(self, batch_data):
        ...
        _, distance_vectors, _ = get_pbc_distances(cart_coords, edge_index, lattice_lengths, lattice_angles,
