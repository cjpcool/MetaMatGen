...
conf_enc_nequip['average_num_neigh'] = 10
...
conf_model['max_num_atoms'] = 4224
conf_model['min_num_atoms'] = 6
...
conf_model['noise_end'] = 5.0
conf_model['cutoff'] = 1.0
conf_model['max_num_neighbors'] = 10
conf_model['coord_loss_type'] = 'per_node'
conf_model['use_node_num_loss'] = True
conf_model['property_dim'] = 12


conf_optim = {'lr': 1e-03, 'betas': [0.9, 0.999], 'weight_decay': 0.0}

conf['edge_pred_weight'] = 10.0
...
conf['gen_temp'] = [1., 1., 1.0, 1., 0.01]  # comp/node_num, pos, prop, lattice, decode_pos
