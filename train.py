...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path', type=str, default='result_modulus_32/', help='The directory for storing training outputs')
    ...
    dataset = runner.load_data(data_path, args.dataset, file_name='data_node_num32')
