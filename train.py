...
parser.add_argument('--result_path', type=str, default='result_3/', help='The directory for storing training outputs')
...
parser.add_argument('--load_model_path', type=str, default='/home/jianpengc/projects/materials/MetaMatGen/result_2/model_519.pth', help='load checkpoint')
